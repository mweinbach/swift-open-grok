...
// prerelease/channel strings (e.g. `0.1.220-open-grok.21`). The Rust reference
...
extension SemVerVersion {
    /// `true` when the version has a prerelease tag (e.g. `-open-grok.21`).
    ...
    /// The prerelease tag as a dot-joined string (e.g. `open-grok.21`), or
    /// empty when absent.
