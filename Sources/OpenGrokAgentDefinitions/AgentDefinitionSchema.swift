...
extension AgentToolConfiguration {
    public static let defaultGrokBuild = AgentToolConfiguration(tools: [
        ...
        "spawn_subagent", "agent_swarm", "swarm_wait", "scheduler_create", "scheduler_delete", "scheduler_list", "monitor",
