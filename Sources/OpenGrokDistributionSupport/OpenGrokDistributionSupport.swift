...
// read-only Rust reference at `b962dfa6dd9a49df96d28412eae3a8f5478b0dfa`:
//
...
public enum OpenGrokDistributionSupport {
    ...
    public static let referenceRevision = "b962dfa6dd9a49df96d28412eae3a8f5478b0dfa"

    /// The upstream release pinned at ``referenceRevision`` (`OPEN_GROK_VERSION`).
    public static let referencePinnedRelease = "1.0.0-open-grok.82"
}
