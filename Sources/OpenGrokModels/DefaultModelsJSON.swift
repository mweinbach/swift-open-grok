...
/// Raw `default_models.json` body, matching `xai_grok_models::DEFAULT_MODELS_JSON`.
public let DEFAULT_MODELS_JSON: String = #"""
{
  ...
  "models": [
    ...
    },
    {
      ...
      "description": "Kimi Code's coding and agent model",
      "base_url": "https://api.kimi.com/coding/v1",
      "context_window": 262144,
      "api_backend": "chat_completions",
      "provider": "kimi",
    ...
    },
    {
      ...
      "description": "Kimi Code's low-latency coding and agent model",
      "base_url": "https://api.kimi.com/coding/v1",
      "context_window": 262144,
      "api_backend": "chat_completions",
      "provider": "kimi",
